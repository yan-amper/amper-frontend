  ...
  <S.Section id="address">
    <S.Container>
      ...
      <S.ContentGrid>
        ...
        <S.InfoContainer>
          {/* Внутри магазина, а не фасад: фасад стоит в первом экране,
              и второй раз то же здание здесь ничего не добавляет.
              Витрина с аккумуляторами отвечает на другой вопрос —
